...
experiment=get_mlflow_experiment(experiment_name='app_recommendation')

if( experiment is None):
    experiment_id = create_mlflow_experiment(experiment_name='app_recommendation', artifact_location='app_recommendation_artifacts', tags={"env": "dev", "version": "1.0.0"})
    experiment=get_mlflow_experiment(experiment_id=experiment_id)
    
print("Name: {}".format(experiment.name))

with mlflow.start_run(run_name="recommending_models", experiment_id=experiment.experiment_id) as run:
